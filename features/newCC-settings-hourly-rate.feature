Feature: New CC Update Setting/ Regular Rate
    ...
    Scenario: 03. I get data Setting/ Update Package Hourly Rate
        Given Get token when login Account NewCC from "Lab"
            | user     | password   |
            | tappcar1 | demo@12345 |
        When I send request to api "https://ccliteapis.lab.qup.vn/api/packagerate/edit" with request with params based on table below
            | requestBody                                                                                                                                                                                                                                                                  |
            | {"fleetId":"tappcar","fareHourlyId":"58f81460e4b0e611751d03eb","name":"Premium: 1 Day","duration":1,"type":"day","coveredDistance":500,"feesByCurrencies":[{"currencyISO":"CAD","basedFee":899,"extraDuration":799,"extraDistance":14.99}],"_id":"5c0f450aaa612f2599146ed2"} |
        Then I should get the return data matches with
            | res                                                                                                                                                     |
            | {"_id":"5c0f450aaa612f2599146ed2","fareHourlyId":"58f81460e4b0e611751d03eb","fleetId":"tappcar","name":"Premium: 1 Day", "type":"day", "isActive":true} |
